...
public class ConsultaControllerTest {
    ...
    @Test
    @DisplayName("Devolver HTTP 400 quando informaçoes invalidas")
    @WithMockUser
    ...
    @Test
    @DisplayName("Devolver HTTP 200 quando informaçoes validas -- essa praga deu trabalho")
    @WithMockUser
    void agendarCenario02() throws Exception {
        ...
        var jsonEsperando = dadosDetalhamentoConsultaJson.write(dadosDetalhamento).getJson();

           assertThat(response.getContentAsString()).isEqualTo(jsonEsperando);
